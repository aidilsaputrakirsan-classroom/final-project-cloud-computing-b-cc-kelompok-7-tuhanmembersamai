...
// Endpoint search untuk AJAX (POST /eksplorasi/search)
Route::post('/eksplorasi/search', [App\Http\Controllers\ExplorationController::class, 'search'])->name('eksplorasi.search');
